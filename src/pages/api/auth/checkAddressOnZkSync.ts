...
const checkAddressOnZkSync = async (address: string): Promise<boolean> => {
  const zkSyncApiUrl = `https://api-era.zksync.network/api?module=account&action=balance&address=${address}&tag=latest&apikey=A445QM53W9RK7JC4ECVGHX9VP2PH3KT4W2`;
